...
class Categories(models.Model):  
     ...
     sort_index = models.IntegerField(default=100, verbose_name='Порядок сортировки')
...
class Products(models.Model):
     ...
     quantiti=models.PositiveIntegerField(default=0.00,verbose_name='Количество')
     ...
     def __str__(self):
        return f'{self.name} Количество - {self.quantiti}'
